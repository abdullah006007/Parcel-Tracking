              ...
              <div className="relative">
                ...
                <div className="space-y-10">
                  {allStatuses.map((status, index) => {
                    ...
                    const statusEntry = hasOccurred ? parcel.deliveryStatus.slice().reverse().find(s => s.status === status.value) : null;
                            ...
                            {hasOccurred ? (
                              <>
                                <p className="text-gray-600 mt-2">
                                  {statusEntry?.details || `Package ${status.label.toLowerCase()}`}
                                </p>
                                ...
                                {statusEntry?.location && (
                                  <div className="flex items-center text-sm text-gray-500 mt-2">
                                    <FaMapMarkerAlt className="mr-2 text-gray-400" /> {statusEntry?.location}
                                  </div>
                                )}
                              </>
                            ) : (
